...
/**
 * Task to compute (and delete) top users for two days before yesterday
 *
 * @author Jan Drabek
 */
public class TwoDaysBeforeYesterdayTopUsersTask extends TaskInContext {

	private static final Logger logger = Logger.getLogger(TwoDaysBeforeYesterdayTopUsersTask.class.getName());
	...
	public void execute(TaskExecutionContext tec) throws RuntimeException {
		...
		FlickrEntity entity = new TopUsers(context,DateTimeHelper.formatDate(DateTimeHelper.shiftDate(3*1000*24*3600)));
		try {
			//entity.unload();
			entity.load();
