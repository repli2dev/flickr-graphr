...
public interface DatabaseQuery {
        ...
        * @return resulting query data (mostly JSON, see concrete implementations)
        * @throws DatabaseQueryException
        */
        String execute() throws DatabaseQueryException;
        
        /**
         * Sets a parameter for query (for concrete parameters required, see documentation in implementations)
