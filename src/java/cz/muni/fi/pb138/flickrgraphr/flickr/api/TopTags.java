...
/**
 * Represents one page of Flickr API - Hot list->hot-list It takes care of
 * downloading, validation and transforming the received data and its
 * (de)storing into database
 *
 * @author Jan Drabek
 */
public class TopTags extends AbstractFlickrEntity {
	...
	/**
	 * Returns date (which was previously set or current date if haven't been set)
	 * @return 
	 */
	public Date getDate() {
		if (date == null) {
